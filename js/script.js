...
/* Create two variables. For the first variable, add a Boolean and a string and display the coerced result.
    ...
    console.log(firstCoercedResult);
    let secondCoercedResult = 10 + false;    
    console.log(secondCoercedResult);
    let thirdCoercedResult = 10 + true;    
    console.log(thirdCoercedResult);
...
string, number, Boolean, object, and undefined. */
    let myCity = "Irvine";
    console.log("myCity datatype is: " + typeof myCity);
    let luckyNumber = 7;
    console.log("luckyNumber datatype is: " + typeof luckyNumber);
    let trueFalse = true;
    console.log("trueFalse datatype is: " + typeof trueFalse);
    let myCar = {make:"BMW", color:"White"};
    console.log("myCar datatype is: " + typeof myCar);
    let unknown;
    console.log("unknown datatype is: " + typeof unknown);

// STEP 11
/* Within an alert box, use the concatenation operator (+) to display text in the alert box that appears as follows: 
Hello Zak Ruvalcaba, welcome to the JavaScript class! Substitute my name for your name. Although not necessary in practice, 
